...
class _LibrariesScreenState extends State<LibrariesScreen> with SingleTickerProviderStateMixin {
  late TabController _tabController;
  final LibraryService _libraryService = LibraryService();
  
  List<Library> _myLibraries = [];
  ...
  Future<void> _loadLibraries() async {
    ...
    try {
      ...
      // Load both user's libraries and public libraries
      final myLibraries = await _libraryService.getUserLibraries(currentUserId);
      final publicLibraries = await _libraryService.getPublicLibraries();
      
      // Filter out user's own libraries from public libraries to avoid duplicates
      final filteredPublicLibraries = publicLibraries
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Kütüphane Ekle', style: TextStyle(color: Colors.white)),
      ),
    );
  }
  ...
  Widget _buildPublicLibrariesTab() {
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return _buildLibraryCard(_publicLibraries[index], isUserLibrary: false);
        },
      ),
    );
  }
  
  Widget _buildLibraryCard(Library library, {required bool isUserLibrary}) {
    return Card(
      ...
      child: InkWell(
        onTap: () {
          ...
          AppRoutes.navigateTo(context, AppRoutes.libraryDetail, arguments: library.id);
        },
        borderRadius: BorderRadius.circular(12.0),
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: library.imageUrl != null && library.imageUrl!.isNotEmpty
                    ? DecorationImage(
              ...
              child: Stack(
                children: [
                  if (library.imageUrl == null || library.imageUrl!.isEmpty)
                    Center(
                      child: Icon(
                        Icons.library_books,
                        size: 48,
                      ...
                      child: Row(
                        children: [
                          CircleAvatar(
                            ...
                            child: IconButton(
                              icon: Icon(
                                library.isPublic ? Icons.public : Icons.public_off,
                                size: 16,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 4),
                      Text(
                        '${_formatTimeOfDay(library.openingTime)} - ${_formatTimeOfDay(library.closingTime)}',
                        style: AppTextStyles.bodyMedium.copyWith(color: AppColors.textSecondary),
                      ),
                    ],
                  ),
